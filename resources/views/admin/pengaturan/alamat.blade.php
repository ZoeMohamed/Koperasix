                            ...
                            <div class="col-md-12">
                                <table>
                                    <tr>
                                        ...
                                        <th>:</th>
                                        <td style="padding: 1rem;">{{ $alamat->detail }} , {{ $alamat->kota }} , {{ $alamat->prov }}</td>
                                    </tr>
                                </table>
                                <small><a href="{{ route('admin.pengaturan.ubahalamat', ['id' => $alamat->id]) }}">Klik
                                        untuk mengubah alamat toko</a></small>
                            </div>
                        </div>
                    </div>
                </div>
